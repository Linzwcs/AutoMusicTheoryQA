...
class IntervalNumberQuestion(BasePrototype):
    ...
    def produce(music_sheet: 'MusicSheet'):
        ...
        minor_incorrect_answer = correct_answer

        if "minor" in minor_incorrect_answer:
            minor_incorrect_answer.replace("minor", "major")
        if "major" in minor_incorrect_answer:
            minor_incorrect_answer.replace("major", "minor")

        if minor_incorrect_answer not in incorrect_answers + [correct_answer]:
            incorrect_answers = [minor_incorrect_answer] + incorrect_answers
        ...
        return MusicTheorySingleChoiceQuestion(
            ...
            category=IntervalNumberQuestion.category,
            ...
            class_name=IntervalNumberQuestion.__name__)
